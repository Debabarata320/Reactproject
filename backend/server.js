...
mongoose.connect('mongodb+srv://admin:admin@cluster0.npmh8.mongodb.net/mernstack?retryWrites=true&w=majority', { useNewUrlParser: true, useUnifiedTopology: true }, (err) => {
    if (!err) {
